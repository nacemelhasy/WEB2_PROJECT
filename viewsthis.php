...
$query = "SELECT * FROM  precensestate  where precensestate.Sid = $id and subCode = '$subCode'";
$days = array();
$count = 0;
...
foreach($days as $i){
 if($i[1]){
    ...
    $historey[$count] = "<li class='list-group-item list-group-item-success'>تاريخ المحاظرة  : $d </li>"; 
    $count++;
}else{
    $d = $i[0];
    $historey[$count] = "<li class='list-group-item list-group-item-danger'>تاريخ المحاظرة  : $d </li>";
    $count++;
 }
}
$listitem 
